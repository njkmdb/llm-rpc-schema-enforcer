...
* **2026.09.22 (v0.4.1)**  
・Added `X-Correlation-ID` header pass-through for client distributed tracing  
・Added token usage, response latency, and retry count to the RPC response `meta` field  
